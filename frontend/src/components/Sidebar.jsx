...
export default function Sidebar() {
  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-command-border bg-command-panel shadow-sm">
      {/* Brand Header */}
      <div className="border-b border-command-border px-6 py-6 bg-gradient-to-r from-white via-command-bg/10 to-transparent">
